...
* Setting an empty filename in GUI prompt no longer tries to `mv dir/foo.png dir/`
* Now auto-sets format for files with no extension to resolve Nextcloud UI issues
...
* Bug where Nextshot would continue to run when missing required config options
